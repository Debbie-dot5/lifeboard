  ...
  return (
    <div ref={menuRef} className="fixed bottom-6 right-6 z-50">
          ...
          {ACTIONS.map((action, i) => {
            ...
            return (
              <button
                ...
                className="flex items-center gap-3 bg-[#1A1A2E] rounded-xl px-4 py-3 hover:bg-white/10 transition-all animate-fade-in-up whitespace-nowrap"
                style={{
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-[#6C47FF] hover:bg-[#5835FF] text-white flex items-center justify-center shadow-lg shadow-[#6C47FF]/25 transition-all duration-200 hover:scale-105"
      >
